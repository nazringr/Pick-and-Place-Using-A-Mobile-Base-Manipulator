...
def generate_launch_description():
    ...
    # UR Joint Position Controller Node
    robot_ur_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
    ...
    # Delay start of robot_controller after `joint_state_broadcaster`
    delay_robot_ur_controller_spawner_after_joint_state_broadcaster_spawner = RegisterEventHandler(
        event_handler=OnProcessExit(
            target_action=joint_state_broadcaster_spawner,
            on_exit=[robot_ur_controller_spawner],
        )
    )
    ...
    return LaunchDescription(
        [   
            ...
            delay_robot_ur_controller_spawner_after_joint_state_broadcaster_spawner,
            tf
        ]
    )